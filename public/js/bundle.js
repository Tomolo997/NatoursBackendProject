    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            console.log('you just logged in ', email, password);
            _context.prev = 1;
            _context.next = 4;
...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoidG9tYXpvdnNlbmphayIsImEiOiJja2lxYTRhd28wZGoxMnhwamF3MTI1YjA5In0.cCRWR0uclCv1ecYzmJ0Y_w';
  ...
  locations.forEach(function (loc) {
    ...
    new mapboxgl.Popup({
      offset: 30
    }).setLngLat(loc.coordinates).setHTML("<p>Day ".concat(loc.day, ": ").concat(loc.description, "</p>")).addTo(map); //extend te map bounds
...
var stripe = Stripe('pk_test_51IdbjtLHUylvxLGERt8KzVbyajRcAkoLrQLJySdNOrGOd6vwOaIREXvoEAoyu7ASFryKCl4wMMEPxqINMNheY81C00oVagKgp0');
...
var bookTourButton = document.getElementById('book-tour');
